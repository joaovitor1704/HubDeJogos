...
namespace Hub.Projetos.Login.Repository;

public class UsuariosRepository
{
    public List<Usuario> Usuarios = new List<Usuario>();
    public string fileName = @"C:\Users\joaov\OneDrive\Documentos\Imã\HubDeJogos\Hub\Projetos\Login\Repository\UsuariosCadastrados.json";
